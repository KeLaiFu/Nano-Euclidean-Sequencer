...
#define MAX_DELAY_TIME 1000   // Limit the slowest loop time to 1 sec per step.
...
void showBitPattern(int channelNumber, unsigned int pattern, int patternLength, int mode) {
  ...
  switch (channelNumber) {
    case 0: R =  0; G =  0; B = (int) cnt; break;  // Pattern/trigger 1 will be shown in red.
    case 1: R =  0; G = (int) cnt; B =  0; break;  // Pattern/trigger 2 will be shown in green.
    case 2: R = (int) cnt; G =  0; B =  0; break;  // Pattern/trigger 3 will be shown in blue.
